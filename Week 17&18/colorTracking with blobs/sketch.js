...
function preload()
{
  salmon = loadImage('assets/salmon.png')
}
...
function draw() {
    ...
    //var sizeX = blobs[0].maxx - blobs[0].minx;
    //var sizeY = blobs[1].miny - blobs[1].miny;
    
    //image(salmon, video.width, 100)
     //image(salmon, blobs[0].minx , blobs[0].miny, sizeX, sizeY)
}
