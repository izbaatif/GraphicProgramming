...
function myFilter(img){
  ...
  var matrixSizeX = matrixX.length;
  var matrixSizeY = matrixY.length;
  ...
  for (var x = 0; x < imgOut.width; x++) {
      for (var y = 0; y < imgOut.height; y++) {
          ...
          var cX = convolution(x, y, matrixX, matrixSizeX, img);
          //get highest value colvolutiin can return
          //(1+2+1) *255 = 1020
          cX = map(abs(cX[0]),0, 1020 ,0, 255);
          
          
          var cY = convolution(x, y, matrixY, matrixSizeY, img);
