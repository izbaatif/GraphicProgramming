...
function setupDominoes(){
  // your code here
  var stack = Composites.stack(100, 400, 10, 1, 20, 0, function()
  {
    Domino = Bodies.rectangle(100, 400, 10, 100, {isStatic:true});

    return Body.create({Domino});
